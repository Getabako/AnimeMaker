#!/usr/bin/env node
/**
 * AnimeMaker — local web UI for codex app-server.
 * Boots the bundled Next.js standalone server.
 */
...
(async () => {
  ...
  const port = await pickPort(Number(process.env.PORT) || 4571);
